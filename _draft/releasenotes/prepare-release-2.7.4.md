...
## Bug Fixes
### Paladin
Exorcism now triggers if the target is Demon or Undead.
...
_Developer's Note: This delay is annoying but it became mandatory with Siege of Orgrimmar patch for Mists of Pandaria Classic. Not delaying caused an error when opening the options panel while in combat._
### Paladin
Paladin's The Art of War now displays its Spell Alert.
### Glowing Buttons
...
## Known Limitations
It is possible that the above fixes do not work exactly as the game client. These fixes already required a ton of work, doing better would be even worse. Again, this is a band-aid to help Blizzard, please don't shoot the medic, thank you :)
## Contributors
