...
As an example of the latter condition, Revenge could fail to glow if its option was set to "Defensive Stance only" and would correctly glow if the option was set to "All stances".
...
## Bug Fixes
### Druid
Druids no longer get error from loading Eclipse Moon and Eclipse Sun textures at start.
## Contributors
Shout-out to our amazing contributors
