...
## Bug Fixes
### Shaman
Animations of Rolling Thunder (Season of Discovery) are now on par with other animations.
## Miscellaneous
...
## Bug Fixes
### Shaman
Animations of Fulmination Cataclysm are now on par with other animations.
## Miscellaneous
Overlays are never displayed after 60 seconds of leaving combat, up from 30 seconds.
...
New Glowing Buttons
- Drain Soul, when the target has 20% health of less
- Incinerate\*\*, during Backdraft
- Chaos Bolt\*\*, during Backdraft
- Incinerate\*\*, during Fire and Brimstone
- Immolate\*\*, during Fire and Brimstone
- Conflagrate\*\*, during Fire and Brimstone
- Curse of the Elements\*\*, during Fire and Brimstone
- Curse of Enfeeblement\*\*, during Fire and Brimstone
...
New Glowing Buttons
- Overpower\*, during Taste for Blood
- Victory Rush\*, during Victorious
- Impending Victory, during Victorious
...
## Bug Fixes
### Mage
The Freeze effect would always glow Ice Lance and Deep Freeze. Options for their respective buttons have been added.
### Shaman
Animations of Fulmination are now on par with other animations.

Shamans should no longer get invited to report unsupported effect Maelstrom.
### Warrior
Warriors should no longer get invited to report the following unsupported effects:
- Sudden Death
- Bloodsurge
- Sword and Board
- Ultimatum
