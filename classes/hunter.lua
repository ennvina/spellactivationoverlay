...
local function registerAuras(self)
    ...
    -- Lock and Load, option 1: display the first charge on top-left and second charge on top-right
    -- Advantages: displays 2 charges, doesn't conflict with Improved Steady Shot
